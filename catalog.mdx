...
Calculate the exchange value for a product from its configured trade-in selections. The available selection fields and values depend on the product's exchange configuration.

| Method | Endpoint | Auth |
| --- | --- | --- |
| `POST` | `/products/{productId}/exchange-quote` | `x-api-key` |
